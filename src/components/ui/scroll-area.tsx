  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        // which shrink-to-fits to the widest child and breaks `truncate` (long
        // content overflows the panel). Force it to block so it fills the
        // viewport width and truncation works.
